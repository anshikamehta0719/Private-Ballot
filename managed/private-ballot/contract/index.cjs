...
class Contract {
  ...
  constructor(...args_0) {
    ...
    this.circuits = {
      castVote: (...args_1) => {
        ...
        const support_0 = args_1[1];
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.originalState != undefined && contextOrig_0.transactionContext != undefined)) {
          __compactRuntime.type_error('castVote',
                                      'argument 1 (as invoked from Typescript)',
                                      'private-ballot.compact line 91 char 1',
                                      'CircuitContext',
                                      contextOrig_0)
        }
        if (!(typeof(support_0) === 'boolean')) {
          __compactRuntime.type_error('castVote',
        ...
        const partialProofData = {
          input: {
            value: _descriptor_0.toValue(support_0),
        ...
        const result_0 = this._castVote_0(context, partialProofData, support_0);
      ...
      closeVoting: (...args_1) => {
        ...
        const contextOrig_0 = args_1[0];
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.originalState != undefined && contextOrig_0.transactionContext != undefined)) {
          __compactRuntime.type_error('closeVoting',
                                      'argument 1 (as invoked from Typescript)',
                                      'private-ballot.compact line 115 char 1',
                                      'CircuitContext',
                                      contextOrig_0)
        }
        const context = { ...contextOrig_0 };
  ...
  initialState(...args_0) {
    ...
    const adminKeyHash_0 = args_0[1];
    const proposalText_0 = args_0[2];
    const initialVoterCommitments_0 = args_0[3];
    ...
    if (!(adminKeyHash_0.buffer instanceof ArrayBuffer && adminKeyHash_0.BYTES_PER_ELEMENT === 1 && adminKeyHash_0.length === 32)) {
      __compactRuntime.type_error('Contract state constructor',
                                  'argument 1 (argument 2 as invoked from Typescript)',
                                  'private-ballot.compact line 66 char 1',
                                  'Bytes<32>',
                                  adminKeyHash_0)
    }
    if (!(Array.isArray(initialVoterCommitments_0) && initialVoterCommitments_0.length === 8 && initialVoterCommitments_0.every((t) => t.buffer instanceof ArrayBuffer && t.BYTES_PER_ELEMENT === 1 && t.length === 32))) {
      __compactRuntime.type_error('Contract state constructor',
                                  'argument 3 (argument 4 as invoked from Typescript)',
                                  'private-ballot.compact line 66 char 1',
                                  'Vector<8, Bytes<32>>',
                                  initialVoterCommitments_0)
    }
                    ...
                    [
                     { push: { storage: false,
                               value: __compactRuntime.StateValue.newCell({ value: _descriptor_6.toValue(2n),
                                                                            alignment: _descriptor_6.alignment() }).encode() } },
                     { push: { storage: true,
                               value: __compactRuntime.StateValue.newCell({ value: _descriptor_5.toValue(proposalText_0),
                                                                            alignment: _descriptor_5.alignment() }).encode() } },
                     { ins: { cached: false, n: 1 } }]);
    Contract._query(context,
                    partialProofData,
    ...
    this._folder_0(context,
                   ...
                   ((context, partialProofData, t_0, commitment_0) =>
                    {
                      const revealed_0 = commitment_0;
                      if (!this._equal_0(revealed_0, zero_0)) {
                        Contract._query(context,
                                        partialProofData,
                                        [
                                         { idx: { cached: false,
                                         ...
                                         { push: { storage: false,
                                                   value: __compactRuntime.StateValue.newCell({ value: _descriptor_1.toValue(revealed_0),
                                                                                                alignment: _descriptor_1.alignment() }).encode() } },
                                         { push: { storage: true,
  ...
  _localSecretKey_0(context, partialProofData) {
    ...
    if (!(result_0.buffer instanceof ArrayBuffer && result_0.BYTES_PER_ELEMENT === 1 && result_0.length === 32)) {
      __compactRuntime.type_error('localSecretKey',
                                  'return value',
                                  'private-ballot.compact line 60 char 1',
                                  'Bytes<32>',
                                  result_0)
    }
  ...
  _castVote_0(context, partialProofData, support_0) {
    ...
    const nullifier_0 = this._persistentHash_0(this._persistentHash_0(secret_0));
    __compactRuntime.assert(!_descriptor_0.fromValue(Contract._query(context,
                                                                     partialProofData,
                                                                     [
                                                                      { dup: { n: 0 } },
  ...
  _closeVoting_0(context, partialProofData) {
    const secret_0 = this._localSecretKey_0(context, partialProofData);
    __compactRuntime.assert(this._equal_1(this._persistentHash_0(secret_0),
      ...
      member(...args_0) {
        ...
        if (!(elem_0.buffer instanceof ArrayBuffer && elem_0.BYTES_PER_ELEMENT === 1 && elem_0.length === 32)) {
          __compactRuntime.type_error('member',
                                      'argument 1',
                                      'private-ballot.compact line 44 char 1',
                                      'Bytes<32>',
                                      elem_0)
        }
        return _descriptor_0.fromValue(Contract._query(context,
    ...
    usedNullifiers: {
      ...
      member(...args_0) {
        ...
        if (!(elem_0.buffer instanceof ArrayBuffer && elem_0.BYTES_PER_ELEMENT === 1 && elem_0.length === 32)) {
          __compactRuntime.type_error('member',
                                      'argument 1',
                                      'private-ballot.compact line 48 char 1',
                                      'Bytes<32>',
                                      elem_0)
        }
        return _descriptor_0.fromValue(Contract._query(context,
